...
import com.damar.meaty.databinding.FragmentGayaHidupBinding
import com.damar.meaty.databinding.FragmentRecipeBinding
import com.damar.meaty.local.Artikel

class GayaHidupFragment : Fragment() {

    private var _binding: FragmentGayaHidupBinding? = null
    private lateinit var binding: FragmentGayaHidupBinding
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentGayaHidupBinding.inflate(inflater, container, false)
        ...
        AnimationUtil.playArtikelGayaHidupAnimation(binding)
        return view
    }
